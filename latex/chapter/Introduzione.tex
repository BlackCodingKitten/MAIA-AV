...
or the exploitation of superficial correlations and linguistic biases. In this contex \textit{MAIA: Multimodal AI Assessment} by Testa et al.(2025)\cite{testa2025maia} was introduced as a native Italian 
...
Statement Verification}" extends the original MAIA research framework to a more complex analysis of the interaction between visual, linguistic, 
