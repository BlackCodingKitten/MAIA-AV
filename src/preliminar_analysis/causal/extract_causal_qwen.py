...
EVENT_DIR = Path("data/preliminar_analysis/event/qwen")
OUTPUT_DIR = Path("data/preliminar_analysis/causal/qwen")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Causal inference Qwen2.5-Omni-3B dagli eventi consolidati.")
