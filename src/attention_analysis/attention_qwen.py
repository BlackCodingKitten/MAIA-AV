...
#   GPU 4 -> cuda:0
#
# Only physical GPU 4 is visible to PyTorch.
# ============================================================
...
OUTPUT_DIR = Path("data/attention_analysis/qwen2.5-omni-3B")
...
# Only physical GPU 4 is visible.
...
def load_model(
    ...
    common_kwargs = {
        # CUDA_VISIBLE_DEVICES="4" makes physical GPU 4
        # appear inside the process as cuda:0.
        #
        # Force the whole model onto that single GPU so no
        # layer is sharded across multiple CUDA devices.
        "device_map": {"": 0},
